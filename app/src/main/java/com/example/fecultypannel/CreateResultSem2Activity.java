...
public class CreateResultSem2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_result_sem2);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ProgressDialog progressDialog = new ProgressDialog(CreateResultSem2Activity.this);
                progressDialog.setMessage("Please Wait...");
                progressDialog.show();

                RequestQueue requestQueue = Volley.newRequestQueue(CreateResultSem2Activity.this);
                String url = "http://adkkda34.atwebpages.com/f_add_result_sem2.php";
                StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        progressDialog.dismiss();
                        Toast.makeText(CreateResultSem2Activity.this, "Response", Toast.LENGTH_SHORT).show();
                        Log.e("sem2", response);
                    }
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressDialog.dismiss();
                        Log.e("sem2error", "" + error);
                        Toast.makeText(CreateResultSem2Activity.this, "Something Went wrong...", Toast.LENGTH_SHORT).show();
                    }
                }) {
                    @Override
