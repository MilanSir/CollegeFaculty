...
public class CreateResultSem6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_result_sem6);
        ...
        btnCalculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                tv_total.setText("" + total + "/290");

                float cgpi = (float) total * 10 / 290;
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ProgressDialog progressDialog = new ProgressDialog(CreateResultSem6Activity.this);
                progressDialog.setMessage("Please Wait...");
                progressDialog.show();

                RequestQueue requestQueue = Volley.newRequestQueue(CreateResultSem6Activity.this);
                String url = "http://adkkda34.atwebpages.com/f_add_result_sem6.php";
                StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        progressDialog.dismiss();
                        Toast.makeText(CreateResultSem6Activity.this, "Response", Toast.LENGTH_SHORT).show();
                        Log.e("sem6", response);
                    }
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressDialog.dismiss();
                        Log.e("sem6error", "" + error);
                        Toast.makeText(CreateResultSem6Activity.this, "Something Went wrong...", Toast.LENGTH_SHORT).show();
                    }
                }) {
                    @Override
